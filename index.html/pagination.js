...
description.innerText =
  " Users can navigate between these pages by clicking below Buttons.";
...
table_th3.innerText = "Email";
 let elements_div= createtable("tagname")
 elements_div.setAttribute("class","table table-bordered");
...
maindiv.append(title, description, content_div, table_div,elements_div);
